...
public class StudyModifyRequest {
    ...
    @Builder
    public StudyModifyRequest(String userAccount, String title, String content, Category category, String city, String street, String zipcode, Integer recruitCnt, LocalDate startedAt, LocalDate expiredAt, Period period, ProcessType processType) {
